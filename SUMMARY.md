...
* [Terraform + AWS](programming/devops/README.md)
...
* [AWS \(Architect path\)](programming/aws-architect-path/README.md)
  * [Course Fundamentals and AWS Accounts](programming/aws-architect-path/course-fundamentals-and-aws-accounts.md)
  * [Cloud Computing Fundamentals](programming/aws-architect-path/cloud-computing-fundamentals.md)
  * [Tech Fundamentals](programming/aws-architect-path/tech-fundamentals.md)
  * [AWS Fundamentals](programming/aws-architect-path/aws-fundamentals.md)
  * [IAM, ACCOUNTS AND AWS ORGANISATIONS](programming/aws-architect-path/iam-accounts-and-aws-organisations.md)
  * [SIMPLE STORAGE SERVICE \(S3\)](programming/aws-architect-path/simple-storage-service-s3.md)
  * [VIRTUAL PRIVATE CLOUD \(VPC\) BASICS](programming/aws-architect-path/virtual-private-cloud-vpc-basics.md)
  * [ELASTIC COMPUTE CLOUD \(EC2\) BASICS](programming/aws-architect-path/elastic-compute-cloud-ec2-basics.md)
  * [CONTAINERS & ECS](programming/aws-architect-path/containers-and-ecs.md)
  * [ADVANCED EC2](programming/aws-architect-path/advanced-ec2.md)
  * [Route 53 - Global DNS](programming/aws-architect-path/route-53-global-dns.md)
  * [Relational Database Service \(RDS\)](programming/aws-architect-path/relational-database-service-rds.md)
  * [NETWORK STORAGE](programming/aws-architect-path/network-storage.md)
  * [HA & SCALING](programming/aws-architect-path/ha-and-scaling.md)
  * [SERVERLESS AND APPLICATION SERVICES](programming/aws-architect-path/serverless-and-application-services.md)
  * [GLOBAL CONTENT DELIVERY AND OPTIMIZATION](programming/aws-architect-path/global-content-delivery-and-optimization.md)
  * [ADVANCED VPC Networking](programming/aws-architect-path/advanced-vpc-networking.md)
  * [HYBRID ENVIRONMENTS AND MIGRATION](programming/aws-architect-path/hybrid-environments-and-migration.md)
...
* [Code security](programming/code-security.md)
* [CodeClimate](programming/codeclimate.md)
* [Dev ops](programming/dev-ops.md)
