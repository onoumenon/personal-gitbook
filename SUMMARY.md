...
* [Dev ops](programming/dev-ops/README.md)
  ...
  * [Gmail Emails](programming/dev-ops/gmail-emails.md)
...
* [AWS (Architect path)](books/aws-architect-path/README.md)
  * [Course Fundamentals and AWS Accounts](books/aws-architect-path/course-fundamentals-and-aws-accounts.md)
  * [Cloud Computing Fundamentals](books/aws-architect-path/cloud-computing-fundamentals.md)
  * [Tech Fundamentals](books/aws-architect-path/tech-fundamentals.md)
  * [AWS Fundamentals](books/aws-architect-path/aws-fundamentals.md)
  * [IAM, ACCOUNTS AND AWS ORGANISATIONS](books/aws-architect-path/iam-accounts-and-aws-organisations.md)
  * [SIMPLE STORAGE SERVICE (S3)](books/aws-architect-path/simple-storage-service-s3.md)
  * [VIRTUAL PRIVATE CLOUD (VPC) BASICS](books/aws-architect-path/virtual-private-cloud-vpc-basics.md)
  * [ELASTIC COMPUTE CLOUD (EC2) BASICS](books/aws-architect-path/elastic-compute-cloud-ec2-basics.md)
  * [CONTAINERS & ECS](books/aws-architect-path/containers-and-ecs.md)
  * [ADVANCED EC2](books/aws-architect-path/advanced-ec2.md)
  * [Route 53 - Global DNS](books/aws-architect-path/route-53-global-dns.md)
  * [Relational Database Service (RDS)](books/aws-architect-path/relational-database-service-rds.md)
  * [NETWORK STORAGE](books/aws-architect-path/network-storage.md)
  * [HA & SCALING](books/aws-architect-path/ha-and-scaling.md)
  * [SERVERLESS AND APPLICATION SERVICES](books/aws-architect-path/serverless-and-application-services.md)
  * [GLOBAL CONTENT DELIVERY AND OPTIMIZATION](books/aws-architect-path/global-content-delivery-and-optimization.md)
  * [ADVANCED VPC Networking](books/aws-architect-path/advanced-vpc-networking.md)
  * [HYBRID ENVIRONMENTS AND MIGRATION](books/aws-architect-path/hybrid-environments-and-migration.md)
  * [SECURITY, DEPLOYMENT & OPERATIONS](books/aws-architect-path/security-deployment-and-operations.md)
  * [NOSQL Databases & DynamoDB](books/aws-architect-path/nosql-databases-and-dynamodb.md)
  * [Prep](books/aws-architect-path/prep.md)
* [Learn Enough](books/learn-enough.md)
