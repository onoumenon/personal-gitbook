...
* [Access Control](programming/access-control.md)
  * [Django Groups](programming/access-control/django-groups.md)
...
* [Testing](programming/testing/README.md)
  ...
  * [Django](programming/testing/django.md)
  * [React](programming/testing/react/README.md)
    * [StoryBook](programming/testing/react/storybook.md)
    * [Jest](programming/testing/react/jest/README.md)
      * [Object Containing](programming/testing/react/jest/jest.md)
      * [Mock](programming/testing/react/jest/mock.md)
...
* [Dev ops](programming/dev-ops/README.md)
  ...
  * [Google Admin](programming/dev-ops/google-admin.md)
* [Productivity](programming/productivity.md)
...
* [Ruby/ ROR](frameworks-libraries-languages/back-end/README.md)
  * [template for set up](frameworks-libraries-languages/back-end/template-for-set-up.md)
  * [Make ruby gem](frameworks-libraries-languages/back-end/make-ruby-gem.md)
  * [TDD](frameworks-libraries-languages/back-end/tdd.md)
  * [Ruby](frameworks-libraries-languages/back-end/ruby/README.md)
    * [Intro](frameworks-libraries-languages/back-end/ruby/intro.md)
    * [Ruby Date and Time](frameworks-libraries-languages/back-end/ruby/ruby-date-and-time.md)
    * [Additional stuff](frameworks-libraries-languages/back-end/ruby/additional-stuff.md)
    * [Ruby Koans](frameworks-libraries-languages/back-end/ruby/ruby-koans.md)
  * [Ruby on Rails](frameworks-libraries-languages/back-end/ruby-on-rails/README.md)
    * [Set up](frameworks-libraries-languages/back-end/ruby-on-rails/set-up.md)
    * [Intro](frameworks-libraries-languages/back-end/ruby-on-rails/intro.md)
    * [MVC](frameworks-libraries-languages/back-end/ruby-on-rails/mvc.md)
    * [Views](frameworks-libraries-languages/back-end/ruby-on-rails/views-templates.md)
    * [Models](frameworks-libraries-languages/back-end/ruby-on-rails/models.md)
    * [Enable s3](frameworks-libraries-languages/back-end/ruby-on-rails/untitled.md)
    * [Enable pagination](frameworks-libraries-languages/back-end/ruby-on-rails/enable-pagination.md)
    * [ActiveSupport Concern, rspec, openURI](frameworks-libraries-languages/back-end/ruby-on-rails/activesupport-concern-rspec-etc.md)
    * [Active Jobs & Sidekiq](frameworks-libraries-languages/back-end/ruby-on-rails/active-jobs-and-sidekiq.md)
    * [State machines](frameworks-libraries-languages/back-end/ruby-on-rails/state-machines.md)
    * [OTP Auth](frameworks-libraries-languages/back-end/ruby-on-rails/otp-auth.md)
    * [Code 'health'](frameworks-libraries-languages/back-end/ruby-on-rails/code-health.md)
* [Redis](frameworks-libraries-languages/redis.md)
* [Elixir](frameworks-libraries-languages/elixir/README.md)
  * [Intro & setup](frameworks-libraries-languages/elixir/intro-and-setup.md)
  * [Basic types, basic operators](frameworks-libraries-languages/elixir/basic-types-basic-operators.md)
  * [Pattern matching, case, cond, and if](frameworks-libraries-languages/elixir/pattern-matching-case-cond-and-if.md)
  * [Binaries, strings, charlists, keyword lists, maps](frameworks-libraries-languages/elixir/binaries-strings-charlists-keyword-lists-maps.md)
  * [Modules, function, recursion](frameworks-libraries-languages/elixir/modules-function-recursion.md)
  * [Enumerables, streams](frameworks-libraries-languages/elixir/enumerables-streams-processes.md)
  * [Processes](frameworks-libraries-languages/elixir/i-o-file-system-require-import-alias.md)
  * [I/O, file system, require, import, alias](frameworks-libraries-languages/elixir/i-o-file-system-require-import-alias-1.md)
  * [module attributes](frameworks-libraries-languages/elixir/module-attributes.md)
  * [Structs, Protocols](frameworks-libraries-languages/elixir/structs-protocols.md)
  * [Comprehensions](frameworks-libraries-languages/elixir/comprehensions.md)
  * [Sigils](frameworks-libraries-languages/elixir/sigils.md)
  * [try catch rescue](frameworks-libraries-languages/elixir/try-catch-rescue.md)
  * [typespecs, behaviours, debugging](frameworks-libraries-languages/elixir/debugging.md)
  * [erlang libraries, what next](frameworks-libraries-languages/elixir/erlang-libraries-what-next.md)
  * [Mix, Agent](frameworks-libraries-languages/elixir/mix-agent.md)
  * [GenServer](frameworks-libraries-languages/elixir/genserver.md)
  * [misc](frameworks-libraries-languages/elixir/misc.md)
  * [Sage (Saga Pattern)](frameworks-libraries-languages/elixir/sage-saga-pattern.md)
* [Phoenix](frameworks-libraries-languages/phoenix.md)
* [Django](frameworks-libraries-languages/django/README.md)
  * [Deployment](frameworks-libraries-languages/django/deployment.md)
* [JavaScript](frameworks-libraries-languages/javascript/README.md)
  * [Resources](frameworks-libraries-languages/javascript/resources.md)
  * [Event loop](frameworks-libraries-languages/javascript/event-loop.md)
  * [This](frameworks-libraries-languages/javascript/this.md)
  * [Closures](frameworks-libraries-languages/javascript/closures.md)
  * [Memoize](frameworks-libraries-languages/javascript/memoize.md)
  * [Debounce](frameworks-libraries-languages/javascript/debounce.md)
  * [Other JS Concepts](frameworks-libraries-languages/javascript/other-js-concepts.md)
  * [Useful Formatters/ Utils](frameworks-libraries-languages/javascript/useful-formatters-utils/README.md)
    * [phone numbers](frameworks-libraries-languages/javascript/useful-formatters-utils/phone-numbers.md)
* [React](frameworks-libraries-languages/react/README.md)
  * [Error logging](frameworks-libraries-languages/react/error-logging.md)
  * [React Intro](frameworks-libraries-languages/react/untitled.md)
  * [React concepts](frameworks-libraries-languages/react/react-concepts.md)
  * [Testing](frameworks-libraries-languages/react/testing/README.md)
    * [React Testing Library](frameworks-libraries-languages/react/testing/react-testing-library.md)
    * [Jest](frameworks-libraries-languages/react/testing/jest.md)
  * [React Redux](frameworks-libraries-languages/react/untitled-1.md)
  * [Typescript](frameworks-libraries-languages/react/typescript.md)
* [React Native](frameworks-libraries-languages/react-native-1/README.md)
  * [New Architecture](frameworks-libraries-languages/react-native-1/new-architecture.md)
  * [React Native Issues](frameworks-libraries-languages/react-native-1/react-native.md)
  * [React Native Intro](frameworks-libraries-languages/react-native-1/react-native-1.md)
  * [Libraries](frameworks-libraries-languages/react-native-1/libraries.md)
  * [Testing](frameworks-libraries-languages/react-native-1/testing.md)
  * [React Navigation](frameworks-libraries-languages/react-native-1/react-navigation.md)
  * [React Native Splash Screen](frameworks-libraries-languages/react-native-1/react-native-splash-screen.md)
* [Development for Apple](frameworks-libraries-languages/development-for-apple/README.md)
  * [Code signing](frameworks-libraries-languages/development-for-apple/apple-developers.md)
* [Android](frameworks-libraries-languages/android.md)
* [FE animation](frameworks-libraries-languages/fe-animation.md)
* [EmberJS](frameworks-libraries-languages/emberjs/README.md)
  * [EmberJS QuickStart](frameworks-libraries-languages/emberjs/emberjs.md)
  * [EmberJS Objects](frameworks-libraries-languages/emberjs/emberjs-objects.md)
  * [EmberJS Templates](frameworks-libraries-languages/emberjs/emberjs-templates.md)
  * [EmberJS Routes](frameworks-libraries-languages/emberjs/emberjs-routing.md)
  * [EmberJS Components](frameworks-libraries-languages/emberjs/emberjs-components.md)
* [Postgresql commands](frameworks-libraries-languages/postgres.md)
